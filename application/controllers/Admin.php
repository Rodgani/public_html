...
class Admin extends CI_Controller
{
  ...
  $autoabo_detail['elektro']              = isset($_POST['elektro'])? '1' : '0';
	$autoabo_detail['waiting_days']        = $_POST['waiting_days'];
  $autoabo_detail['min_age']        = $_POST['min_age'];
  $autoabo_detail['enabled']              = isset($_POST['enabled'])? '1' : '0';
	...
	$prices_details['3m850km']   = $this->setKm('3m850km');
	$prices_details['3m1250km']  = $this->setKm('3m1250km');
	$prices_details['3m1850km']  = $this->setKm('3m1850km');
	$prices_details['3m3250km']  = $this->setKm('3m3250km');
	$prices_details['6m850km']   = $this->setKm('6m850km');
	$prices_details['6m1250km']  = $this->setKm('6m1250km');
	$prices_details['6m1850km']  = $this->setKm('6m1850km');
	$prices_details['6m3250km']  = $this->setKm('6m3250km');
	$prices_details['12m850km']  = $this->setKm('12m850km');
	$prices_details['12m1250km'] = $this->setKm('12m1250km');
	$prices_details['12m1850km'] = $this->setKm('12m1850km');
	$prices_details['12m3250km'] = $this->setKm('12m3250km');
	$prices_details['24m850km']  = $this->setKm('24m850km');
	$prices_details['24m1250km'] = $this->setKm('24m1250km');
	$prices_details['24m1850km'] = $this->setKm('24m1850km');
	$prices_details['24m3250km'] = $this->setKm('24m3250km');
	$prices_details['36m850km']  = $this->setKm('36m850km');
	$prices_details['36m1250km'] = $this->setKm('36m1250km');
	$prices_details['36m1850km'] = $this->setKm('36m1850km');
	$prices_details['36m3250km'] = $this->setKm('36m3250km');
...
public function mietemich()
  ...
  $mietemich_detail['elektro']              = isset($_POST['elektro'])? '1' : '0';
  $mietemich_detail['enabled']              = isset($_POST['enabled'])? '1' : '0';
...
public function mietemich_image_delete(){
  ...
  function setKm($index) {
    return isset($_POST[$index]) ? $_POST[$index] : 0;
  }
