      ...
      <table>
        ...
        <tr>
          <td class="content">
            ...
            <p>Vielen Dank, dass Sie sich für die Automobile Wohlensee entschieden haben. Wir haben Ihre Anfrage für das
              Fahrzeug erhalten. Wir werden Sie so schnell wie möglich per E-Mail oder per Handy kontaktieren.</p>

            <h4><?= $vehicle_data['vehicle_brand'] . " " . $vehicle_data['vehicle_name']; ?></h4>
            <table>
              <tr>
                <td style="width:40%;">Getriebe</td>
              ...
              <tr>
                <td>Dauer</td>
                <td><?= str_replace('h', '', $duration); ?> Stunden</td>
              </tr>
              <tr>
                <td>Kilometer</td>
                <td><?= $km; ?></td>
            ...
            <table>
              <tr>
                <td style="width:40%;">Mietpreis</td>
                <td><?= $price; ?> CHF</td>
              </tr>
            </table>
            <br/>
