...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>Anfrage<small> Detail</small></h1>
    <ol class="breadcrumb">
  ...
  <div class="col-md-6 mt-3 p-4 text-heading">Gutschein-Code</div>
  <div class="col-md-6 mt-3 p-4 text-desc"><?php echo $request[0]['promocode']; ?></div>
  ...
  <div class="col-md-6 mt-3 p-4 text-heading">Aufmerksam</div>
  <div class="col-md-6 mt-3 p-4 text-desc"><?php echo $request[0]['aufmerksam'] ?></div>
