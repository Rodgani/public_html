      ...
      <div class="container p-5">
        <div class="row">
          <div class="col mcontroler">
            <div class="bg-grey-alt text-center py-4">
          		...
          		<span style="color:#14cc00;">
							...
							<ul class="list-left-br my-5">
								...
								<li>
									...
									Nach deinem Zahlungseingang kannst du schnellstmöglich losfahren.
								</li>
							</ul>
							<h5 class="mt-5">Können wir helfen?</h5>
							<p>Unser Team hilft dir gerne unter <a class="violet-blue-accent-text" href="mailto:info@automobile-wohlensee.ch">info@automobile-wohlensee.ch</a> oder <a class="violet-blue-accent-text" href="tel:+41315031012">+41 (0)31 503 10 12</a>.</p>
<?php /*?>
