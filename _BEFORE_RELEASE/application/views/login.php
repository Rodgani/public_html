...
<html>
  <head>
    ...
    <title> Admin | Automobile-wohlensee.ch</title>
    ...
    <div class="login-box">
      ...
      <div class="login-box-body">
        ...
        <form action="" method="POST" id="admin_login">
          ...
          <div class="row">
            <div class="col-xs-12">
              <input type="submit" id="btn-login" class="btn btn-primary btn-block" value="Sign in"><br>
            </div>
          </div>
        </form>
        <!-- /.social-auth-links -->
        <a href="<?php base_url(); ?>Login/forget_password">I forgot my password</a><br>
      </div>
      <!-- /.login-box-body -->
    </div>
    <!-- /.login-box -->
