  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Instrumententafel</li>
      </ol>
    </section>
...
<div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              <h3><?php echo $autoabo_pending_count ?></h3>

              <p>monatliche automatische Abonnementanfragen heute</p>
            </div>
            <div class="icon">
         ...
         <div class="col-lg-8">
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Letzte Anfragen für ein monatliches Abonnement</h3>
            ...
            <div class="box-body">
              <div class="table-responsive">
                <table class="table no-margin">
                  ...
                  <tbody>
                    <?php foreach ($recent_autoabo_requests as $key => $value){ 
                      $label = '';
                    ...
                    <tr>
                    <td><a href="<?php echo base_url() ?>Requests/requestview/autoabo/<?php echo $value['autoabo_request_id']?>">MAA <?php echo $value['autoabo_request_id'] ?></a></td>
                    <td><?php echo $value['vorname'] ?></td>
                    <td><?php echo $value['telefon_nummer'] ?></td>
                    <td><?php echo $value['vehicle_name'] ?></td>
                    <td><span class="label label-<?php echo $label; ?> text-capitalize"><?php
                      if($value['status'] == 'pending'){
                        echo "Offen";
                      }
                      if($value['status'] == 'connected'){
            ...
            <div class="box-footer clearfix">
              <a href="<?php echo base_url() ?>requests/get/autoabo/all" class="btn btn-sm btn-default btn-flat pull-right">View All Orders</a>
            </div>
            <!-- /.box-footer -->
          </div>
      </div>
      ...
      <div class="col-lg-4">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Kürzlich hinzugefügte Fahrzeuge für monatliche Abonnements</h3>
            ...
            <div class="box-body">
              <ul class="products-list product-list-in-box">
                ...
                <?php foreach ($recent_autoabo as $key => $value): ?>
               <?php 
               $autoabo_images = explode(',', $value['images']);
               $autoabo_image = $autoabo_images[0];

                ?>   
               
                <li class="item">
                  <div class="product-img">
                    <img src="<?php echo base_url();?>uploads/autoabo/<?php echo $autoabo_image; ?>" alt="Product Image">
                  </div>
            ...
            <div class="box-footer text-center">
              <a href="<?php echo base_url() ?>admin/autoabo" class="uppercase">Alle Fahrzeuge anzeigen</a>
            </div>
            <!-- /.box-footer -->
          </div>
      </div>
