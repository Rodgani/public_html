  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header">MAIN Instrumententafel</li>
        <li>
          <a href="<?php echo base_url(); ?>admin"> 
            <i class="fa fa-dashboard"></i> <span>Instrumententafel</span>
        ...
        <li class="header"> Fahrzeuge verwalten</li>
         <li>
          <a href="<?php echo base_url().'admin/autoabo'; ?> ">
            <i class="fa fa-dashboard"></i> <span>monatliches Abo</span>
            <span class="pull-right-container">
            </span>
        </a>
        </li>
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-dashboard"></i> <span>monatliche Abonnements</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url(); ?>requests/get/autoabo/all"><i class="fa fa-circle-o"></i>Alles Requests</a></li>
            <li><a href="<?php echo base_url(); ?>requests/get/autoabo/pending"><i class="fa fa-circle-o"></i>steht aus</a></li>
            <li><a href="<?php echo base_url(); ?>requests/get/autoabo/connected"><i class="fa fa-circle-o"></i>In Verbindung gebracht</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo base_url(); ?>requests/custom_requests"><i class="fa fa-dashboard"></i>benutzerdefinierte Anfragen</a></li>
        ...
        <li class="header" > DIE EINSTELLUNGEN </li>
        <li class="treeview">
          <a href="#">
            <i class="fa fa-gear"></i> <span>DIE EINSTELLUNGEN</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
