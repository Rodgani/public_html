                  ...
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col text-right">
                        <a class="btn  btn-success custom-btn text-white rounded" style="font-size: 12px;" style="margin-top: 11px;" id="send_request">Jetzt buchen</a>
                      </div>
                    </div>
                  </div>
                </div>
   ...
   <div class="card-body">
       ...
       <div class=" mcontroler">
            <div class=" bg-white px-2 py-2 h-100">
               <h4 class="font-weight-bold my-2 h5">Beschreibung</h4>
