...
<?php */ ?>                
                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6 text-right">
                        ...
                        <a class="btn btn-success text-white rounded">Jetzt abonnieren</a>
                ...
                <h6 class="text-primary font-weight-bold mb-0"><i class="fa fa-shield " aria-hidden="true"></i> &nbsp;Was ist im Carvolution-Service enthalten?</h6>
<?php */?>
              </div>
            </div>
            <?php /* ?>
            <p class="mt-4 mb-0 text-center">Frühestens verfügbar: <b><?php// echo date('d. F Y', strtotime($mietemich[0]['date_from'])) ?></b></p>

            <p class="text-center">Zzgl. <?php echo $mietemich[0]['36m850km']; ?> CHF Anfangspauschale für Neukunden</p>
            <?php */?>
          ...
          <div class="col-lg-6 col-md-8 pr-4">
            ...
            <ul class="list-group">
              ...
              <li class="list-group-item border-left-0 border-right-0 px-0 py-2 rounded-0">
                <b>Kategorie</b>
                <span class="float-right"><?php echo $mietemich[0]['vehicle_category'] ?></span>
                <div class="clearfix"></div>
              </li>
              <li class="list-group-item border-left-0 border-right-0 px-0 py-2">
                <b>Motor</b>
                <span class="float-right"><?php echo $mietemich[0]['vehicle_engine']; ?></span>
                <div class="clearfix"></div>
              </li>
              <li class="list-group-item border-left-0 border-right-0 px-0 py-2">
                <b>Getriebe</b>
                <span class="float-right"><?php echo $mietemich[0]['transmision_type']; ?></span>
                <div class="clearfix"></div>
              </li>
              <li class="list-group-item border-left-0 border-right-0 px-0 py-2">
                <b>Antrieb</b>
                <span class="float-right"><?php echo $mietemich[0]['vehicle_drive_type']; ?></span>
                <div class="clearfix"></div>
              </li>
              ...
              <li class="list-group-item border-left-0 border-right-0 px-0 rounded-0">
                <b>Treibstoff</b>
                <span class="float-right"><?php echo $mietemich[0]['vehicle_fuel_type']; ?></span>
                <div class="clearfix"></div>
              </li>
